...
int main() {
	...
	if (file.is_open()) {
		...
		file.seekg(0, std::ios::beg); //перемещение курсора в начало ф-ла для считывания
	...
	//Задача  - Добавление в середину файла
...
bool insert_file(std::string file_path, int position, std::string str) {
	...
	//Шаг 1. Копирование содержимого ф-ла в строку
